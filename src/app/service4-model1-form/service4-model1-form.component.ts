...
@Component({
  selector: 'app-service4-model1-form',
  templateUrl: './service4-model1-form.component.html',
  styleUrls: ['./service4-model1-form.component.scss'],
  // encapsulation: ViewEncapsulation.None
})

export class Service4Model1FormComponent implements OnInit,AfterViewChecked {
