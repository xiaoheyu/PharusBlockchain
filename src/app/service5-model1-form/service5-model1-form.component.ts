...
@Component({
  selector: 'app-service5-model1-form',
  templateUrl: './service5-model1-form.component.html',
  styleUrls: ['./service5-model1-form.component.scss'],
  // encapsulation: ViewEncapsulation.None
})

export class Service5Model1FormComponent implements OnInit,AfterViewChecked {
