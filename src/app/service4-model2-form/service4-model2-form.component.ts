...
@Component({
  selector: 'app-service4-model2-form',
  templateUrl: './service4-model2-form.component.html',
  styleUrls: ['./service4-model2-form.component.scss'],
  // encapsulation: ViewEncapsulation.None
})

export class Service4Model2FormComponent implements OnInit,AfterViewChecked {
  ...
  ngAfterViewChecked(){
	  if ($('#serviceFourContainer').length===1){
