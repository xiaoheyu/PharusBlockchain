...
@Component({
  selector: 'app-service5-model2-form',
  templateUrl: './service5-model2-form.component.html',
  styleUrls: ['./service5-model2-form.component.scss'],
  // encapsulation: ViewEncapsulation.None
})

export class Service5Model2FormComponent implements OnInit,AfterViewChecked {
  ...
  tooltipContent="Purchase Model 2 at "+this.modelTwoPrice+"<span class=\"balanceUnit\"> ETH</span>"
  test:any[];
  ...
  ngAfterViewChecked(){
	  if ($('#serviceFiveContainer').length===1){
